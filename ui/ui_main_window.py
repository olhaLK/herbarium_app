...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 813, 442))
        ...
        self.scrollAreaWidgetContents.setStyleSheet(u"border: 2 solid rgb(255, 170, 127);")
